...
def parse_agent_file(file_path: Path) -> dict:
    ...
    try:
        ...
        valid_tools = {
            'GetCategories', 'GetServices', 'BookTimes', 'FindSlots', 'CreateBooking', 'ViewService', 'FindMasterByService',  # из service_tools
        ...
        for agent in agents:
            try:
                ...
                if agent['tools']:
                    ...
                    try:
                        from src.agents.tools.service_tools import GetCategories, GetServices, BookTimes, FindSlots, CreateBooking, ViewService, FindMasterByService
