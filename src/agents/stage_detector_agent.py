...
ОЧЕНЬ ВНИМАТЕЛЬНО СМОТРИ ИСТОРИЮ СООБЩЕНИЙ. ЧАСТО ТЫ МОЖЕШЬ ПОНЯТЬ КАКАЯ СТАДИЯ ТОЛЬКО ИЗ ПРОШЛЫХ СООБЩЕНИЙ. Но, если клиент сначала задавал вопросы по услугам, а потом сказал что хочет записаться на услугу, это значит что надо выбирать стадию связанную с бронированием.
