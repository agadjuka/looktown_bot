...
- tool_tester: Клиент просит протестировать инструменты, задает вопросы о работе инструментов, хочет проверить функциональность системы или инструментов ("протестируй инструмент", "как работает BookTimes?", "проверь GetCategories", "протестируй все инструменты").
