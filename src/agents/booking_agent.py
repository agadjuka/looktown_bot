...
Покажи клиенту весь этот список в понятном формате. Пиши все услуги. Если в списке есть одинаковые услуги МАСТЕР и ТОП-МАСТЕР, сделай в одном сообщении два списка для МАСТЕР и для ТОП-МАСТЕР
