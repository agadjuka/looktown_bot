...
Используй инструмент GetServices с указанием category_id, и отправь клиенту все услуги полученные в списке. Уточни на какую именно услугу он хочет записаться. 
