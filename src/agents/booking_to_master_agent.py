...
Пример: "На {дата} у Анны есть следующие свободные слоты: {слот}, {слот}".
Если свободных слотов нет: "К сожалению, на [дата] у мастера [Имя мастера] свободных мест уже нет. Посмотрим на другой день?"
...
"На {дата} у [Имя мастера  в правильном склонении] есть следующие свободные слоты (указано доступное время начала сеанса): 
-{слот}
-{слот}
