...
Используй getservices, чтобы получить список услуг для выбранной категории. Покажи клиенту весь список услуг в этой категории (ВЕСЬ СПИСОК ЗНАЧИТ ВСЕ ПОЗИЦИИ, И МАСТЕР И ТОП МАСТЕР ЕСЛИ ТАКОЕ ЕСТЬ).
...
Получив дату, используй инструмент book_times, ОБЯЗАТЕЛЬНО указав master_name. 
