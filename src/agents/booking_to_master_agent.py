...
Шаг 3: Когда клиент выбрал конкретную услугу, используй инструмент FindSlots указав только ID услуги и имя мастера. В ответ ты получишь ближайшие 3 доступных дня. Скажи клиенту "Ближайшее доступное время для {название услуги в правильном падеже}: (перечисли доступное время)."
...
Формулировка: "Готово! Я записала вас на [название услуги] {дата} в {время} к мастеру {имя мастера}. Будем вас ждать!"""
        ...
        super().__init__(
            ...
            tools=[FindSlots, CreateBooking, FindMasterByService, CallManager, Masters],
